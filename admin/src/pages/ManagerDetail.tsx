...
export default function ManagerDetail() {
  ...
  if (!manager) return (
    <div className="flex flex-col items-center justify-center py-32 gap-3">
      ...
      <Button variant="secondary" onClick={() => navigate('/managers')}>← Back to Managers</Button>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-5 animate-fade-in max-w-3xl">
      ...
      {/* Edit Modal */}
      {form && (
        <Modal open={editOpen} onClose={() => setEditOpen(false)} title="Edit Manager" subtitle={`Editing ${manager.name}`}>
