...
export default function DriverDetail() {
  ...
  const DUMMY_TRIPS = [
    { _id: 't1', status: 'Completed', date: '2025-04-10', departureTime: '06:00', arrivalTime: '14:00',
      bus:   { name: 'Selam Bus 01', plateNumber: 'AA-12345', capacity: 45, status: 'Active', lastMaintenanceDate: '2025-01-10', insuranceExpiry: '2026-09-01', registrationExpiry: '2026-12-01' },
      route: { name: 'Addis - Dire Dawa Express', origin: 'Addis Ababa', destination: 'Dire Dawa', distance: 515, duration: 480, status: 'Active', totalTrips: 84, stops: [{ name: 'Adama', order: 1, fareFromOrigin: 80 }, { name: 'Awash', order: 2, fareFromOrigin: 150 }] } },
    { _id: 't2', status: 'Completed', date: '2025-03-18', departureTime: '07:30', arrivalTime: '11:30',
      bus:   { name: 'Selam Bus 02', plateNumber: 'AA-23456', capacity: 45, status: 'Active', lastMaintenanceDate: '2025-02-05', insuranceExpiry: '2026-08-15', registrationExpiry: '2026-11-20' },
      route: { name: 'Addis - Hawassa Local', origin: 'Addis Ababa', destination: 'Hawassa', distance: 275, duration: 240, status: 'Active', totalTrips: 120, stops: [{ name: 'Mojo', order: 1, fareFromOrigin: 60 }, { name: 'Ziway', order: 2, fareFromOrigin: 110 }] } },
    { _id: 't3', status: 'Planned', date: '2025-06-01', departureTime: '20:00', arrivalTime: '06:00',
      bus:   { name: 'Sky Bus 01', plateNumber: 'AA-34567', capacity: 50, status: 'Active', lastMaintenanceDate: '2025-03-01', insuranceExpiry: '2026-07-10', registrationExpiry: '2027-01-15' },
      route: { name: 'Addis - Bahir Dar Night', origin: 'Addis Ababa', destination: 'Bahir Dar', distance: 578, duration: 600, status: 'Active', totalTrips: 56, stops: [{ name: 'Debre Birhan', order: 1, fareFromOrigin: 90 }] } },
    { _id: 't4', status: 'Cancelled', date: '2025-02-20', departureTime: '08:00', arrivalTime: '20:00',
      bus:   { name: 'Liben Bus 01', plateNumber: 'AA-56789', capacity: 55, status: 'Active', lastMaintenanceDate: '2024-12-15', insuranceExpiry: '2026-10-20', registrationExpiry: '2027-02-28' },
      route: { name: 'Addis - Gondar VIP', origin: 'Addis Ababa', destination: 'Gondar', distance: 738, duration: 720, status: 'Active', totalTrips: 30, stops: [{ name: 'Bahir Dar', order: 1, fareFromOrigin: 280 }] } },
    { _id: 't5', status: 'InTransit', date: '2025-05-06', departureTime: '09:00', arrivalTime: '14:00',
      bus:   { name: 'Selam Bus 02', plateNumber: 'AA-23456', capacity: 45, status: 'Active', lastMaintenanceDate: '2025-02-05', insuranceExpiry: '2026-08-15', registrationExpiry: '2026-11-20' },
      route: { name: 'Addis - Jimma Express', origin: 'Addis Ababa', destination: 'Jimma', distance: 346, duration: 300, status: 'Active', totalTrips: 67, stops: [{ name: 'Woliso', order: 1, fareFromOrigin: 70 }] } },
  ];
                ...
                {DRIVER_STATUSES.map(s => (
                  <button key={s} type="button" onClick={() => set('status', s)}
                    className={`flex-1 py-2 rounded-xl border-2 text-xs font-bold transition-all ${
                      form.status === s ? 'border-gray-900 bg-gray-900 text-white' : 'border-gray-100 text-gray-400 hover:border-gray-300'
                    }`}>{s}</button>
                ))}
              </div>
            </div>
